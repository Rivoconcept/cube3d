...
#    Updated: 2025/01/20 17:59:54 by rhanitra         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CFLAGS = -Wall -Wextra -Werror -g -I $(DIR_GNL) -I $(DIR_MINILIBX) -I $(DIR_LIBFT)
CC = gcc
RM = rm -rf
AR = ar rcs
...
$(EXEC) : $(OBJ_CUB3D) $(GNL) $(LIBFT) $(MINILIBX)
	$(CC)  $(CFLAGS) -o $@ $^ -L$(DIR_GNL) -lgnl -L$(DIR_MINILIBX) -lmlx -lXext -lX11
