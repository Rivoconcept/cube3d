...
/*   Updated: 2025/03/08 14:24:21 by rhanitra         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*char put_map_value(t_params *params, int x, int y)
{
    ...
    moov.left = putval(params, x - 1, y);
    if (moov.real == '0' 
		&& ((moov.down == '1' && moov.right == '1' && putval(params, x + 1, y + 1) == '0') 
		|| (moov.up == '1' && moov.left == '1' && putval(params, x - 1, y - 1) == '0') 
		|| (moov.up == '1' && moov.right == '1' && putval(params, x + 1, y - 1) == '0')
		|| (moov.down == '1' && moov.left == '1' && putval(params, x - 1, y + 1) == '0')))
        return ('1');
    if (moov.real == '0' && ((moov.down == '1' && moov.right == '1') \
		|| (moov.up == '1' && moov.left == '1') \
		|| (moov.up == '1' && moov.right == '1') \
